...
V 1.5
*/
define('API_KEY','638285156:AAE5AQ5BSmEC7JWbb5UPFhey0ezhgw40Hsg');//addtoken
//-----------------------------------------------------------------------------------------
//فانکشن MrPHPBot :
...
$Dev = "626982860", "591092978", "";//add sodo
...
$token = '445478575:AAGjILwwuvT3i6HS1qZ986kFCaKQSvaRHxg';//add token
...
if($textmassage=="/start" && $tc == "private"){
  sendAction($chat_id, 'typing');
	...
	'chat_id'=>$chat_id,
	'text'=>"⚜سلام⚜
به ریات ضد لینک و ضد اسپم حرفه ای خوش آمدید. ربات ساخته شده توسط alpha ghost @alphaghost 
برای راه اندازی ربات در گروه، ربات را در گروه اد کرده و ادمین کنید و. دستور /add را ارسال کنید
...
@alphaghost",
 ...
 ['text'=>"ویرایش پیام",'callback_data'=>'text'],['text'=>"$lockedit2",'callback_data'=>'lockedit']
  ...
  [
 ['text'=>"تبلیغات اوپراتورها",'callback_data'=>'text'],['text'=>"$اوپراتورقفل ",'callback_data'=>'lockoperator']
 ],
  [
...
['text'=>"برگشت",'callback_data'=>'back']
  ...
  elseif($data=="back" && $fm == $owners2){
   ...
   [
['text'=>"کانال ما",'url'=>"https://telegram.me/alphaghost"]
  ],
    ]
    ])
    ]);
    ...
    elseif($data=="help" && $fm == $owners2){
     ...
     'message_id'=>$messageid,
             ...
             *[/]automatic [manage]* ➖ (مدیریت گروه به صورت خودکار توسط ربات)
			 [سازنده ](https://telegram.me/mobin_ag_bot)",
            'parse_mode'=>'MarkDown',
               'reply_markup'=>json_encode([
                   'inline_keyboard'=>[
                     [
...
و...
➖➖➖
[🌟@alphaghost🌟](https://telegram.me/alphaghost)"],
            'reply_markup' => [
                'inline_keyboard' => [
                    [
                        ['text' => "عضویت در ربات", 'url' => 'https://telegram.me/mobin_ag_bot']
                    ],
                    [
